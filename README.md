...
For the Apollo510 Lite EVB-based setup used by this project, the J-Link target is:
...
The project uses third-party software and SDK components, including AmbiqSuite
components, Arm/Packetcraft Cordio software distributed with AmbiqSuite,
Apollo510 startup/runtime support, and the Apollo510L radio-core image.
These components retain their original copyright and license terms and are
